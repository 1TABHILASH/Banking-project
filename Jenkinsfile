    ...
    stages {
        stage('Git checkout') {
            steps {
                   ...
                   git 'https://github.com/1TABHILASH/Banking-project.git'
        ...
        stage('Publish HTML') {
          ...
          stage('Docker build image') {
              steps {
                  ...
                  sh 'sudo docker build -t tabhilash/bank-finance:${BUILD_NUMBER}.0 .'
        ...
        stage('Docker login and push') {
              steps {
                  ...
                  sh 'sudo docker push tabhilash/bank-finance:${BUILD_NUMBER}.0 '
                  }
                }
        }    
